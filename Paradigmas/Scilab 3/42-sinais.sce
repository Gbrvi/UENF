...
a1 = uimenu("parent",g, "label",gettext("Arquivo"));
a2 = uimenu("parent",g, "label",gettext("Sobre"));
uimenu("parent",a1, "label",gettext("Fechar"), "callback", "close(h1)");
	
// Menu: Sobre
uimenu("parent",a2, "label",gettext("Autor da Interface"), "callback","ASCV_Sobre();");
// Sleep to guarantee a better display (avoiding to see a sequential display)
sleep(500);
