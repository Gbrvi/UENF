...
discip = ['Paradigmas de Linguagens','Engenharia de Software','Computação Gráfica','Redes sem Fio', 'Programacao II', 'Calculo II'];
   dia = ['Terça-feira','Quarta-feira','Quinta-feira', 'Sexta-Feira'];
